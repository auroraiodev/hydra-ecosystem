...
@Module({
  imports: [
    ...
    BullModule.registerQueue(
      { name: 'order-processing', defaultJobOptions: { delay: 0, attempts: 5 } },
      { name: 'payment-processing', defaultJobOptions: { delay: 0, attempts: 3 } },
      { name: 'email-notifications', defaultJobOptions: { delay: 0, attempts: 3 } },
      { name: 'inventory-updates', defaultJobOptions: { delay: 0, attempts: 3 } },
      { name: 'search-indexing', defaultJobOptions: { delay: 0, attempts: 3 } },
    ),
  ],
