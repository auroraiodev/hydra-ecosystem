...
export function FooterBrand({ siteName, siteLogo }: FooterBrandProps) {
  return (
    <div className="col-span-1 md:col-span-2 lg:col-span-1">
      ...
      <p className="text-sm text-vault-text-muted mb-4">
        El marketplace de TCG más completo de México.
      </p>
      <div className="flex items-center gap-3">
        <a
          href="https://instagram.com/hydracollect"
          target="_blank"
          rel="noopener noreferrer"
          className="size-8 flex items-center justify-center rounded-full bg-white/5 text-vault-text-muted hover:text-teal hover:bg-white/10 transition-colors"
        ...
        <a
          href="https://facebook.com/hydracollect"
          target="_blank"
          rel="noopener noreferrer"
          className="size-8 flex items-center justify-center rounded-full bg-white/5 text-vault-text-muted hover:text-teal hover:bg-white/10 transition-colors"
          aria-label="Facebook"
