...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 rounded-lg border border-border-subtle bg-surface px-3 py-2 text-sm text-text-body',
...
const SelectContent = ({
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-xl border border-border-subtle bg-surface text-text-body shadow-xl',
...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-lg py-1.5 pl-8 pr-2 text-sm text-text-body outline-none',
      'focus:bg-surface-low focus:text-text-body',
