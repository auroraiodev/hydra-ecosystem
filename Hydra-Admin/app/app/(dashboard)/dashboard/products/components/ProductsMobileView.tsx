        ...
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="relative w-16 h-24 shrink-0 rounded-xl overflow-hidden ring-1 ring-primary/5 shadow-sm">
              ...
              />
              {product.foil && (
                <div className="absolute top-0 right-0 px-1 py-0.5 bg-primary text-[7px] font-bold text-primary-foreground uppercase tracking-tighter">
                  FOIL
                </div>
              )}
            </div>
            <div className="flex-1 min-w-0 flex flex-col justify-between h-24">
              <div>
                <div className="flex flex-wrap gap-1 mb-1.5">
                  <span className="inline-flex px-1.5 py-0.5 rounded text-[8px] font-bold uppercase tracking-widest border border-primary/20 text-primary bg-primary/5">
                    {product.tcg}
                  </span>
                  <span className="inline-flex px-1.5 py-0.5 rounded text-[8px] font-bold uppercase tracking-widest text-muted-foreground/60">
                    {product.category}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-2 gap-4 py-4 border-y border-primary/5">
            <div className="space-y-1.5">
              <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-muted-foreground/40 block">
                Inventario
              </span>
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="size-10 rounded-2xl bg-muted/60 text-foreground flex items-center justify-center hover:bg-primary/10 hover:text-primary active:scale-90 transition-all disabled:opacity-20"
                ...
                <span
                  className={cn(
                    'text-sm font-bold tabular-nums w-4 text-center',
                    product.stock > 5
                      ? 'text-primary'
                      : product.stock > 0
                        ? 'text-orange-500'
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full text-[10px] font-bold uppercase tracking-wider border-none bg-accent text-primary rounded-xl px-3 py-2.5 focus:ring-2 focus:ring-primary/20 outline-none appearance-none cursor-pointer"
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-muted-foreground/40 block mb-1">
                Detalles
              </span>
              <div className="flex flex-wrap gap-1.5">
                <div className="px-2 py-1 bg-muted text-muted-foreground rounded-lg text-[9px] font-bold uppercase tracking-wider flex items-center gap-1.5">
                  Idioma: {resolveLanguageName(product.language) || '—'}
                </div>
                <div className="px-2 py-1 bg-muted text-muted-foreground rounded-lg text-[9px] font-bold uppercase tracking-wider flex items-center gap-1.5">
                  Origen: {product.originLabel}
                </div>
                {['Reestock', 'Commander'].map((tagName) => {
                  ...
                  return (
                    <div
                      key={tagName}
                      className="px-2 py-1 bg-primary/10 rounded-lg text-[9px] font-bold uppercase tracking-wider text-primary"
                    >
                      {tagName}
                    </div>
                  );
