...
export default function SalesHistoryPage() {
  const [state, dispatch] = useReducer(
    (s: SalesState, a: Partial<SalesState>) => ({ ...s, ...a }),
    { sales: [], loading: true, stats: { totalSales: 0, totalAmount: 0, commission: 0 } }
  );
  const { sales, loading, stats } = state;
    ...
    <div className="p-4 sm:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-blue-600 text-white shadow-lg border-none overflow-hidden relative">
          ...
          <CardContent>
            <div className="text-3xl font-semibold">{stats.totalSales}</div>
        ...
        <Card className="bg-purple-600 text-white shadow-lg border-none overflow-hidden relative">
          ...
          <CardContent>
            <div className="text-3xl font-semibold">${stats.commission.toFixed(2)}</div>
...
<div className="flex flex-col items-end" suppressHydrationWarning>
                           ...
                           <span className="text-[10px] opacity-70">
                             <ClientDate date={sale.createdAt} formatter={(d) =>
