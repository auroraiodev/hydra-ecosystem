...
export const serverAdminAPI = {
  getDashboardStats: () => serverApiCall('/admin/dashboard'),
  getOrderStats: () => serverApiCall('/admin/orders/stats'),
  getRevenueAnalytics: (days = 30) => serverApiCall(`/admin/analytics/revenue?days=${days}`),
};
