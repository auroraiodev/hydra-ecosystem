...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  async handleAdminReply(
    ...
    if (this.botMode.get(payload.userId) !== false) {
      ...
      this.server.to('admin_room').emit('bot_mode_changed', { userId: payload.userId, enabled: false });
    }
  ...
  async handleToggleBot(
    ...
    this.server.to('admin_room').emit('bot_mode_changed', { userId: payload.userId, enabled: payload.enabled });
  }
